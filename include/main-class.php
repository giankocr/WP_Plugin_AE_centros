...
class WordPress_Plugin_Starter
{
    ...
    function plugin_admin_menu_function()
    {
        ...
        add_menu_page(__('WordPress Plugin Starter', WPS_TEXT_DOMAIN), __('Directorio', WPS_TEXT_DOMAIN), 'administrator', 'wps-general', null, 'dashicons-admin-generic', 4);
    ...
    {
        // wp_register_style('wps-user-style', WPS_DIRECTORY_URL . '/assets/build/css/style.css', array(), null);
        // wp_register_script('wps-user-script', WPS_DIRECTORY_URL . '/assets/build/css/script.js', array(), null, true);
        // wp_enqueue_script('jquery');
    ...
    { ?>
        ...
        <div class="wrap card">
            ...
            <h1>
                <?php _e('Directorio de Centros Educativos', WPS_TEXT_DOMAIN); ?>
            </h1>

            <p>
                <?php _e('Este plugin permite darle formato al directorio de centros educativos con el shortcode:', WPS_TEXT_DOMAIN); ?>
            </p>
            <code>
            <?php _e(' [centros_educativos]', WPS_TEXT_DOMAIN); ?>
            </code>
    ...
    function plugin_support_page()
    {
        ...
        <div class="wrap card">
            ...
            <!-- support page title -->
            <h1>
                <?php _e('Soporte del Plugin', WPS_TEXT_DOMAIN); ?>
            </h1>

            <!-- support page description -->
            <p>
                <?php _e('Por favor reporte esta información cuando solicite soporte por correo.', WPS_TEXT_DOMAIN); ?>
            </p>
            ...
            <div class="support-debug">
                ...
                <div class="plugin">
                    ...
                    <ul>
                        <li class="support-plugin-version"><strong>
                                <?php _e($plugin['Name']); ?>
                            </strong> version:
                            <?php _e($plugin['Version']); ?>
                        </li>
                        <li class="support-credits">
                            <?php _e('Plugin author:', WPS_TEXT_DOMAIN); ?> <a href="<?php echo $plugin['AuthorURI']; ?>">
                ...
                <div class="theme">
                    <ul>
                        <li class="support-theme-version">
                            <?php printf(__('Active theme %s version: %s', WPS_TEXT_DOMAIN), $wptheme->Name, $wptheme->Version); ?>
                        </li>
                    </ul>
                ...
                <div class="system">
                    ...
                    <ul>
                        <li class="support-php-version">
                            <?php _e('PHP version:', WPS_TEXT_DOMAIN); ?>
                            <?php _e(PHP_VERSION); ?>
                        </li>
                        <li class="support-mysql-version">
                            <?php _e('MySQL version:', WPS_TEXT_DOMAIN); ?>
                            <?php _e(mysqli_get_server_info($wpdb->dbh)); ?>
                        </li>
                        <li class="support-wp-version">
                            <?php _e('WordPress version:', WPS_TEXT_DOMAIN); ?>
                            <?php _e($wp_version); ?>
                        </li>
                    </ul>
            ...
            <div class="support-action">
                <button type="button" class="button" name="Send Mail">
                    <a style="text-decoration: none" href="mailto:gian@gianko.com?Subject=Plugin%20Support%20Directorio">Mail Me</a>
                </button>
            </div>
